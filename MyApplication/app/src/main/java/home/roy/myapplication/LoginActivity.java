package home.roy.myapplication;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ATTENTION: This was auto-generated to implement the App Indexing API.
        // See https://g.co/AppIndexing/AndroidStudio for more information.
        bt=(Button)findViewById(R.id.number_sign_in_button);
        ...
        bt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                it.setClass(LoginActivity.this, LoginActivity2.class);
                startActivity(it);
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        while (!cursor.isAfterLast()) {
            number.add(cursor.getString(ProfileQuery.NUMBER));
            cursor.moveToNext();
        }

        addNumberToAutoComplete(number);
    }
    ...
    private void addNumberToAutoComplete(List<String> numberCollection) {
