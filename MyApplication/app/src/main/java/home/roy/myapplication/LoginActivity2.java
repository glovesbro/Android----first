...
public class LoginActivity2 extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt=(Button)findViewById(R.id.name_sign_in_button);
        ...
        bt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                it.setClass(LoginActivity2.this, LoginActivity.class);
                startActivity(it);
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        while (!cursor.isAfterLast()) {
            name.add(cursor.getString(ProfileQuery.ADDRESS));
            cursor.moveToNext();
        }

        addNameToAutoComplete(name);
    }
    ...
    private void addNameToAutoComplete(List<String> NameCollection) {
